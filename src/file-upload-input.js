...
function bind(root) {
    ...
    root.find('[data-provides="fileinput-upload"]').each(function () {
        let root_elem = $(this);
        let input_elem = root_elem.find('input[type=file]');
        let uploading_file = false;

        /**
         * Trigger input
         */
        root_elem.find('[data-trigger="fileinput"]').on('click', function (e) {
            e.preventDefault();

            input_elem.trigger('click');
        });

        /**
         * File upload input
         */
        input_elem.on('change', function (e) {
         ...
         * File upload remove
         */
        root_elem.find('[data-dismiss="fileinput"]').on('click', function (e) {
            e.preventDefault();
