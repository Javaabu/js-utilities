...
$(document).ready(function () {
    ...
    $('[data-provides="fileinput-upload"] input[type=file]').on('change', function (e) {
        ...
        if (file_size_kb > max_file_size) {
            ...
            notify('', 'File size cannot be greater than ' + max_file_size_mb + 'MB', 'danger');
        ...
        if (!accepted) {
            notify('', 'Only ' + this.accept + ' files are allowed.', 'danger');
            return;
        }
     ...
     * File upload remove
     */
    $('[data-provides="fileinput-upload"] [data-dismiss="fileinput"]').on('click', function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You will not be able to undo deleting this file!',
            type: 'warning',
            showCancelButton: true,
